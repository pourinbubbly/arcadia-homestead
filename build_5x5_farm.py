  ...
  <script>
    ...
    async function subscribePass(type, amountUSDC) {
      ...
      try {
        ...
        // ALWAYS send the exact amount requested without any fallback checks overriding it!
        const tx = await signer.sendTransaction({
          to: TREASURY_ADDRESS,
...
print("REMOVED 0.0002 FALLBACK & UPDATED PASS UI SYNC ACROSS VIEWS SUCCESSFULLY!")
